...
// * (Mats) and manipulating those images in some way
// */
//
///**
// * 
...
//	
//	public ICCEditor() {}
//	public ICCEditor(Mat ipframe){
//		image = ipframe;
//	}
//
//	public void set(Mat ipframe){
//		image = ipframe;
//	}
//	
//	public Mat get(){
...
//	public Mat compress(int ratio){
//		Mat newImage = Mat.create(image.width()*3/ratio,
//				image.height()*3/ratio, image.arrayDepth(), 0);
//		int oldlength = image.arraySize();
//		int newlength = oldlength/ratio;
//		int average = 0;
//		for(int i = 0; i < newlength; i++){
//			average = getAverage(image, i, ratio);
...
//	private int getAverage (Mat ip, int pos, int ratio){
//		int sum = 0;
//		int coverage = 0;
...
//		try{
//			for(; i < fsize; i += 3){
//				image.imageData().put(i, (byte) value);
//			}
//		} catch(Exception e){
//			e.printStackTrace();
//			return;
...
//		double R, G, B, sum;
//		
//		Mat newimg = Mat.create(image.cvSize(), image.depth(), 1);
//		try{
//			for(; i < fsize; i ++){
//				//BLUE
//				cur = image.imageData().get(i++);
//				B = cur*0.07;
//				//GREEN
//				cur = image.imageData().get(i++);
//				G = cur*0.72;
...
//				R = cur*0.21;
//				sum = R + B + G;
////				image.imageData().put(i-2, (byte) sum);
////				image.imageData().put(i-1, (byte) sum);
////				image.imageData().put(i-0, (byte) sum);
...
//	
////	public Mat clone(){
////		int fsize = image.arraySize();
////		Mat newImg = new Mat();
////		try{
////			for(int i = 1; i < fsize; i ++){
////				byte data = image.imageData().get(i);
